...
if __name__ == "__main__":
    save_dir = "synthesis_sentences/gather_bilingual/lwd_182"
    os.makedirs(save_dir, exist_ok=True)
    tts = Text2Speech.from_pretrained(model_file="exp/gather_bilingual/tts_vits_add_blank/latest.pth")

    # lid=1
    # lid = np.asarray(lid)
    xv = np.load(f"/work/ysj/espnet/egs2/ysj/tts1/dump/gather_clean/xvector/eval1_individual/WenDian-00182-xvector.npy")
